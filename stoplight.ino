...
const char* wifiSSID = "Buttars";     // In order for this to work, you MUST specify the SSID for your wifi
const char* wifiPSK  = "Pineapple";   // And the preshared key (wifi password)
...
String ledState = "off";              // Initialize a variable for tracking the state of the LED
                                      // LED States: off, red, yellow, green, cycle
